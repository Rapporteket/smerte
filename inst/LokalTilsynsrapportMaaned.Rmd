...
colnames(sum_raad_maned)
sum_raad_maned[1:5,]

#Tabell
rapbase::mst(
  tab = sum_raad_maned,
  col_names = c("Måned", "Ja", "Ikke behov", "Ikke kapasitet", "Gitt råd", "Annen grunn", "Mangler verdi"),
  type = params$tableFormat,
  cap = paste0("Månedsfordeling for svaralternativet 'Gitt råd' i tilsynstabellen."),
  digs = 0,
