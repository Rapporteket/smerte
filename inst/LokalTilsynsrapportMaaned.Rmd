...
rapbase::mst(
  ...
  digs = 0,
  align = c("l", "r", "r", "r", "r", "r", "r"))
}ifelse(colnames(sum_raad_maned) == "montname", colnames(sum_raad_maned) == "1", colnames(sum_raad_maned) == "2", colnames(sum_raad_maned) == "3", colnames(sum_raad_maned) == "4", colnames(sum_raad_maned) == "5", colnames(sum_raad_maned) == "6"){
