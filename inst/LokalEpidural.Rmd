...
Denne rapporten gir en oversikt over antall barn som har fått epidural under innleggelse på sykehuset.
...
```{r epibarnfig, warning = FALSE, message=FALSE, results='asis', fig.pos= "H", out.extra = '', fig.align='center', out.width='100%', fig.width = 12}
...
p <- ggplot(bdat, aes(x = alder)) + 
  geom_histogram(color = "darkblue", fill = "lightblue") +
  labs(x = "Alder (år)", y = "Antall", subtitle = "Aldersfordeling hos barn som fikk epidural.") + 
