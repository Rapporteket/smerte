...
params:
  ...
  shinySession: list()
title: '`r paste0(params$hospitalName, params$title, params$startDate, " til ", params$endDate)`'
...
Smerteregisteret har seks kvalitetsindikatorer som skal være til hjelp i utviklingen av god smertebehandling. Merk at det her skilles mellom forløp og pasienter, siden samme pasient kan ha flere forløp. Denne rapporten viser resultater for `r params$hospitalName` i periode `r params$startDate` til `r params$endDate`.
