...
if (dim(dat)[1] < 1) {
  ...
  p1 <- dat |>
    filter(!is.na(stbe)) |>
    mutate(stbe1 = stbe > 0) |>
    group_by(month = monthname, stbe1) |>
    summarise(n = n()) |>
  ...
  p2 <- dat |>
    filter(!is.na(svbe)) |>
    mutate(svbe1 = svbe > 0) |>
    group_by(month = monthname, svbe1) |>
    summarise(n = n()) |>
    mutate(freq2 = n/sum(n)) |>
    filter(svbe1 == 1)
  ...
  p3 <- dat |>
    filter(!is.na(stro)) |>
    mutate(stro1 = stro > 0) |>
    group_by(month = monthname, stro1) |>
    summarise(n = n()) |>
    mutate(freq3 = n/sum(n)) |>
    filter(stro1 == 1)
  ...
  p4 <- dat |>
    filter(!is.na(svro)) |>
    mutate(svro1 = svro > 0) |>
    group_by(month = monthname, svro1) |>
    summarise(n = n()) |>
    mutate(freq4 = n/sum(n)) |>
    filter(svro1 == 1)
  ...
  p = ggplot() + 
    geom_line(data = p1, aes(month, freq1, group = 1, color = "stbe"), size = 0.5) +
    geom_point(data = p1, aes(month, freq1, group = 1, color = "stbe"), shape = 16, size = 1.5) +
    geom_line(data = p2, aes(month, freq2, group = 1, color = "svbe"), size = 0.5) +
    geom_point(data = p2, aes(month, freq2, group = 1, color = "svbe"), shape = 16, size = 1.5) +
    geom_line(data = p3, aes(month, freq3, group = 1, color = "stro"), size = 0.5) +
    geom_point(data = p3, aes(month, freq3, group = 1, color = "stro"), shape = 16, size = 1.5) +
    geom_line(data = p4, aes(month, freq4, group = 1, color = "svro"), size = 0.5) +
    geom_point(data = p4, aes(month, freq4, group = 1, color = "svro"), shape = 16, size = 1.5) +
