...
Smerteregisteret har seks kvalitetsindikatorer som skal være til hjelp i utviklingen av god smertebehandling. Merk at det her skilles mellom forløp og pasienter, siden samme pasient kan ha flere forløp. Denne rapporten viser resultater for `r params$hospitalName` i perioden `r params$startDate` til `r params$endDate`.
...
if (dim(dat)[1] < 1) {
  ...
  p = ggplot() + 
    ...
    theme_classic() +
    scale_x_date(date_labels = "%m-%y") +
    theme(axis.text.x = element_text(size = 10), axis.text.y = element_text(size = 10), axis.title = element_text(size = 12), plot.margin = unit(c(1, 1, 2, 1), "cm"), legend.title = element_text(size = 12), plot.title = element_text(size=12), legend.text = element_text(size = 12), axis.title.y = element_text(margin = margin(t = 0, r = 10, b = 0, l = 0)), axis.title.x = element_text(margin = margin(t = 10, r = 0, b = 0, l = 0))) +
