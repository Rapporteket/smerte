...
```{r kontaktfig, echo=FALSE, warning = FALSE, eval=dataPresent, out.width='80%', fig.cap="\\label{fig:kontaktfig}Antall ganger i kontakt med primær- og spesialisthelsetjenesten på grunn av smerter siste år."}
