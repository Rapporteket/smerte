...
mst(tab = pr6, col_names = c("", "Antall ", "Prosent"),
...
mst(tab = hads, col_names = c("", "Antall ", "Prosent"),
...
mst(tab = tabdep, col_names = c("Score ", "Antall"),
...
mst(tab = tabangst, col_names = c("Score ", "Antall"),
...
gridExtra::grid.arrange(depplot, angstplot, ncol=2)
```
...
mst(tab = evalu, col_names = c("", "Antall ", "Prosent"),
...
mst(tab = eval1, col_names = c("", "Antall ", "Prosent"),
...
datmed <- bind_rows(DolcontinMalfin, FentanylplDurogesicpl, Metadon, Morfin, 
  ...
  magrittr::set_rownames(c("DolcontinMalfin", "FentanylplDurogesicpl", "Metadon",
                 ...
                 "Andre", "Usikker")) |>
  magrittr::set_colnames(c("Antall ja"))
