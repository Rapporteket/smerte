...
if (context %in% c("DEV", "TEST", "QA", "PRODUCTION")) {
  ...
  dat <- read.csv(file = "//ihelse.net/Kvalitetsregister/HBE/2014-00752/OpenQReg/datadumper/prod/Lokale data/Datadump Alle Variable Numerisk/2019-04-01/Datadump_Alle_variabler_numerisk.csv", header = TRUE, sep = ";")
}
