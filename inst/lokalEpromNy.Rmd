...
abstract: 'Testing av et sammendrag som også inneholder "anførselstegn"'
keywords: 'test, av, nøkkelord'
...
```{r rest, eval=dataPresent, results='asis'}
###PRSPM2
...
#Tilsynstabell
#Bruker pakke kableextra
tabPR2 <- mstt(tab = pr2, colnames = c("Søvnproblemer etter innleggelse", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
#Tilsynstabell
#Bruker pakke kableextra
tabPR4 <- mstt(tab = pr4, colnames = c("Har tidligere opplevd belastninger som har krevd behandling av psykolog/psykiater", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
#Tilsynstabell
#Bruker pakke kableextra
tabPR5 <- mstt(tab = pr5, colnames = c("Svar på spørsmålet: ... er det forferdelig, og jeg føler at det aldri kommer til å bli bedre", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
#Tilsynstabell
#Bruker pakke kableextra
tabPR6 <- mstt(tab = pr6, colnames = c("Svar på spørsmålet: ... føles det som om jeg ikke holder ut", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
#Tilsynstabell
#Bruker pakke kableextra
tabH <- mstt(tab = hads, colnames = c("Grunn manglende utfylling HADS", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
#Tilsynstabell
#Bruker pakke kableextra
tabE <- mstt(tab = evalu, colnames = c("Grunn manglende utfylling Eval", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
#Tilsynstabell
#Bruker pakke kableextra
tabE1 <- mstt(tab = eval1, colnames = c("Siden oppstart av behandling fra Smerteteamet, er min smertetilstand blitt", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
#Tilsynstabell
#Bruker pakke kableextra
tabE2 <- mstt(tab = eval2, colnames = c("Siden oppstart av behandling fra Smerteteamet, er min generelle tilstand blitt", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
#Tilsynstabell
#Bruker pakke kableextra
tabE3 <- mstt(tab = eval3, colnames = c("Hvor fornøyd er du med ivaretakelsen fra Smerteteamet", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
#Tilsynstabell
#Bruker pakke kableextra
tabE4 <- mstt(tab = eval4, colnames = c("Snakket behandlerne i smerteteamet til deg slik at du forsto dem", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
#Tilsynstabell
#Bruker pakke kableextra
tabE5 <- mstt(tab = eval5, colnames = c("Har du tillit til smerteteamets faglige dyktighet", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
#Tilsynstabell
#Bruker pakke kableextra
tabE6 <- mstt(tab = eval6, colnames = c("Fikk du tilstrekkelig informasjon og forklaring om din smertetilstand", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
#Tilsynstabell
#Bruker pakke kableextra
tabE7 <- mstt(tab = eval7, colnames = c("Opplevde du at smertebehandlingen var tilpasset din situasjon", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
#Tilsynstabell
#Bruker pakke kableextra
tabE8 <- mstt(tab = eval8, colnames = c("Var du involvert i avgjørelser som angikk din smertebehandling", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
#Tilsynstabell
#Bruker pakke kableextra
tabE9 <- mstt(tab = eval9, colnames = c("Opplevde du at smerteteamets arbeid var godt organisert", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
#Tilsynstabell
#Bruker pakke kableextra
tabE10 <- mstt(tab = eval10, colnames = c("Var hjelpen og behandlingen du fikk av smerteteamet, alt i alt, tilfredsstillende", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
#Tilsynstabell
#Bruker pakke kableextra
tabE11 <- mstt(tab = eval11, colnames = c("Mener du at du på noen måte ble feilbehandlet av smerteteamet?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
#Tilsynstabell
#Bruker pakke kableextra
tabO <- mstt(tab = opio, colnames = c("Grunn manglende utfylling Opioid", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
#Tilsynstabell
#Bruker pakke kableextra
tabmed <- mstt(tab = datmed, colnames = c("Antall ja", "Antall nei"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
    align = c("r", "r"))
...
#Tilsynstabell
#Bruker pakke kableextra
tabbruk <- mstt(tab = bruk, colnames = c("Bruker du fortsatt noen av disse medikamentene?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
tabnedtr <- mstt(tab = nedtr, colnames = c("Fikk du informasjon om nedtrapping av sterke smertestillende medikamenter?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
tabhvem <- mstt(tab = hvem, colnames = c("Av hvem fikk du informasjon om nedtrapping av sterke smertestillende medikamenter?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
tabfulgt <- mstt(tab = fulgt, colnames = c("Klarte du å følge anbefalingene for bruk og nedtrapping av medikamentene?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
tababsti <- mstt(tab = absti, colnames = c("Opplevde du plagsomme abstinenssymptomer (svetting/frysing, uro, smerter, diaré, rennende nese) etter at du ble skrevet ut fra sykehuset?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
tabforstoabsti <- mstt(tab = forstoabsti, colnames = c("Forstod du at det var abstinenssymptomer?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
tablosn <- mstt(tab = losn, colnames = c("Visste du hva du kunne gjøre med problemet?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
tabtrett <- mstt(tab = trett, colnames = c("Opplevde du plagsom tretthet eller følelse av å være medikamentpåvirket etter at du ble skrevet ut fra sykehuset?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
tabtrettlos <- mstt(tab = trettlos, colnames = c("Visste du hva du kunne gjøre med problemet?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
tabbil <- mstt(tab = bil, colnames = c("Fikk du informasjon om sterke smertestillende medikamenter og bilkjøring?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
tabhvembil <- mstt(tab = hvembil, colnames = c("Av hvem fikk du informasjon om sterke smertestillende medikamenter og bilkjøring?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
...
tabhvorinfo <- mstt(tab = hvorinfo, colnames = c("Visste du hvor du kunne henvende deg ved spørsmål om bruk av de smertestillende medikamentene?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
