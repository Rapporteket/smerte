...
```{r kontaktfig, echo=FALSE, warning = FALSE, eval=dataPresent, fig.cap="\\label{fig:kontaktfig}Antall ganger i kontakt med primær- og spesialisthelsetjenesten på grunn av smerter siste år."}
...
#Bruker her pakkene dplyr og magrittr
pr6 <- datpr6 %>%
  count(PRSpm6) %>% mutate(prosent = round(100 * (n / sum(n))))
#Gi navn i stedet for tall til alternativene for tilsyn/ikke tilsyn
pr6 = pr6 %>%
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = pr6, colnames = c("", "Antall ", "Prosent"),
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = hads, colnames = c("", "Antall ", "Prosent"),
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = evalu, colnames = c("", "Antall ", "Prosent"),
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = eval1, colnames = c("", "Antall ", "Prosent"),
...
#Binder data sammen
datmed <- bind_rows(DolcontinMalfin, FentanylplDurogesicpl, Metadon, Morfin, Norspanplaster, OxynormOxykodon, OxyxontinReltebon, Palexia, PalladonHydromorfon, Paralginforte, Buprenorfin, Targiniq, Tramadolvarianter, Andre, Usikker) %>%
  set_rownames(c("DolcontinMalfin", "FentanylplDurogesicpl", "Metadon", "Morfin", "Norspanplaster", "OxynormOxykodon", "OxyxontinReltebon", "Palexia", "PalladonHydromorfon", "Paralginforte", "Buprenorfin", "Targiniq", "Tramadolvarianter", "Andre", "Usikker")) %>% set_colnames(c("Antall ja"))
#Tilsynstabell

#Bruker pakke kableextra
mstt(tab = datmed,
     colnames = c("Antall ja"),
...
hvem <- datO %>%
  count(HvemInfoNedtrapping) %>% mutate(prosent = round(100*(n/sum(n))))
#Gi navn i stedet for tall til alternativene for tilsyn/ikke tilsyn
hvem <- hvem %>%
