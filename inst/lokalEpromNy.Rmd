...
```{r pasreg, warning = TRUE, message=TRUE, results='asis', eval=TRUE}
...
tabPR <- mstt(tab = pasreg, colnames = c("", "Antall ",
                                    "Prosent"),
...
#Bruker pakke kableextra
tabPR1 <- mstt(tab = pr1, colnames = c("Søvnproblemer før innleggelse", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
