...
subtitle: '`r paste(params$hospitalName, " i perioden fra ", params$startDate, " til ", params$endDate)`'
...
cat('# Upps...\nI den valgte tidsperioden er det ikke nok data til å gi ut resultater.')
knitr::knit_exit()
```
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = pr2, colnames = c("Søvnproblemer etter innleggelse", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "prspm2",
    type = params$tableFormat,
...
```{r kontaktfig, echo=FALSE, warning = FALSE, eval=dataPresent}
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = pr4, colnames = c("Har tidligere opplevd belastninger som har krevd behandling av psykolog/psykiater", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "prsmp4",
    type = params$tableFormat,
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = pr5, colnames = c("Svar på spørsmålet: ... er det forferdelig, og jeg føler at det aldri kommer til å bli bedre", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "prspm5",
    type = params$tableFormat,
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = pr6, colnames = c("Svar på spørsmålet: ... føles det som om jeg ikke holder ut", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "prspm6",
    type = params$tableFormat,
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = hads, colnames = c("Grunn manglende utfylling HADS", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "hadsspm",
    type = params$tableFormat,
...
```{r hadsfig, echo=FALSE, warning = FALSE, eval=dataPresent}
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = evalu, colnames = c("Grunn manglende utfylling Eval", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "evalspmtab",
    type = params$tableFormat,
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = eval1, colnames = c("Siden oppstart av behandling fra Smerteteamet, er min smertetilstand blitt", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "evalspm1",
    type = params$tableFormat,
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = eval2, colnames = c("Siden oppstart av behandling fra Smerteteamet, er min generelle tilstand blitt", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "evalspm2",
    type = params$tableFormat,
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = eval3, colnames = c("Hvor fornøyd er du med ivaretakelsen fra Smerteteamet", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "evalspm3",
    type = params$tableFormat,
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = eval4, colnames = c("Snakket behandlerne i smerteteamet til deg slik at du forsto dem", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "evalspm4",
    type = params$tableFormat,
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = eval5, colnames = c("Har du tillit til smerteteamets faglige dyktighet", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "evalspm5",
    type = params$tableFormat,
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = eval6, colnames = c("Fikk du tilstrekkelig informasjon og forklaring om din smertetilstand", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "evalspm6",
    type = params$tableFormat,
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = eval7, colnames = c("Opplevde du at smertebehandlingen var tilpasset din situasjon", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "evalspm7",
    type = params$tableFormat,
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = eval8, colnames = c("Var du involvert i avgjørelser som angikk din smertebehandling", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "evalspm8",
    type = params$tableFormat,
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = eval9, colnames = c("Opplevde du at smerteteamets arbeid var godt organisert", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "evalspm9",
    type = params$tableFormat,
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = eval10, colnames = c("Var hjelpen og behandlingen du fikk av smerteteamet, alt i alt, tilfredsstillende", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "evalspm10",
    type = params$tableFormat,
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = eval11, colnames = c("Mener du at du på noen måte ble feilbehandlet av smerteteamet?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "evalspm11",
    type = params$tableFormat,
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = opio, colnames = c("Grunn manglende utfylling Opioid", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "opiospmtab",
    type = params$tableFormat,
...
#Medikamenter
DolcontinMalfin = datOE %>% select(DolcontinMalfin) %>%  summarise(antja = sum(DolcontinMalfin == 1, na.rm=TRUE)) 
FentanylplDurogesicpl = datOE %>% select(FentanylplDurogesicpl) %>% summarise(antja = sum(FentanylplDurogesicpl== 1, na.rm=TRUE)) 
Metadon= datOE %>% select(Metadon) %>% summarise(antja = sum(Metadon== 1, na.rm=TRUE)) 
Morfin= datOE %>% select(Morfin) %>% summarise(antja = sum(Morfin== 1, na.rm=TRUE)) 
Norspanplaster= datOE %>% select(Norspanplaster) %>% summarise(antja = sum(Norspanplaster== 1, na.rm=TRUE)) 
OxynormOxykodon= datOE %>% select(OxynormOxykodon) %>% summarise(antja = sum(OxynormOxykodon== 1, na.rm=TRUE)) 
OxyxontinReltebon= datOE %>% select(OxyxontinReltebon) %>% summarise(antja = sum(OxyxontinReltebon== 1, na.rm=TRUE)) 
Palexia= datOE %>% select(Palexia) %>% summarise(antja = sum(Palexia== 1, na.rm=TRUE)) 
PalladonHydromorfon= datOE %>% select(PalladonHydromorfon) %>% summarise(antja = sum(PalladonHydromorfon== 1, na.rm=TRUE)) 
Paralginforte= datOE %>% select(Paralginforte) %>% summarise(antja = sum(Paralginforte== 1, na.rm=TRUE)) 
Buprenorfin= datOE %>% select(Buprenorfin) %>% summarise(antja = sum(Buprenorfin== 1, na.rm=TRUE)) 
Targiniq= datOE %>% select(Targiniq) %>% summarise(antja = sum(Targiniq== 1, na.rm=TRUE)) 
Tramadolvarianter= datOE %>% select(Tramadolvarianter) %>% summarise(antja = sum(Tramadolvarianter== 1, na.rm=TRUE)) 
Andre= datOE %>% select(Andre) %>% summarise(antja = sum(Andre== 1, na.rm=TRUE)) 
Usikker= datOE %>% select(Usikker) %>% summarise(antja = sum(Usikker== 1, na.rm=TRUE)) 
#Binder data sammen
datmed = bind_rows(DolcontinMalfin, FentanylplDurogesicpl, Metadon, Morfin, Norspanplaster, OxynormOxykodon, OxyxontinReltebon, Palexia, PalladonHydromorfon, Paralginforte, Buprenorfin, Targiniq, Tramadolvarianter, Andre, Usikker) %>% set_rownames(c("DolcontinMalfin", "FentanylplDurogesicpl", "Metadon", "Morfin", "Norspanplaster", "OxynormOxykodon", "OxyxontinReltebon", "Palexia", "PalladonHydromorfon", "Paralginforte", "Buprenorfin", "Targiniq", "Tramadolvarianter", "Andre", "Usikker")) %>% set_colnames(c("Antall ja"))
#Tilsynstabell

#Bruker pakke kableextra
mstt(tab = datmed, colnames = c("Antall ja"),
    cap = paste0(""),
    label = "medtab",
    type = params$tableFormat,
    digs = 0,
...
#Tilsynstabell
#Bruker pakke kableextra
mstt(tab = bruk, colnames = c("Bruker du fortsatt noen av disse medikamentene?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "medforts",
    type = params$tableFormat,
...
mstt(tab = nedtr, colnames = c("Fikk du informasjon om nedtrapping av sterke smertestillende medikamenter?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "infonedtab",
    type = params$tableFormat,
...
mstt(tab = hvem, colnames = c("Av hvem fikk du informasjon om nedtrapping av sterke smertestillende medikamenter?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "nedtrhvem",
    type = params$tableFormat,
...
mstt(tab = fulgt, colnames = c("Klarte du å følge anbefalingene for bruk og nedtrapping av medikamentene?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "nedrfulgtplan",
    type = params$tableFormat,
...
mstt(tab = absti, colnames = c("Opplevde du plagsomme abstinenssymptomer etter utskrivelse?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "abstietter",
    type = params$tableFormat,
...
mstt(tab = forstoabsti, colnames = c("Forstod du at det var abstinenssymptomer?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "abstiforstod",
    type = params$tableFormat,
...
mstt(tab = losn, colnames = c("Visste du hva du kunne gjøre med problemet?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "abstilosn",
    type = params$tableFormat,
...
mstt(tab = trett, colnames = c("Opplevde du plagsom tretthet eller følelse av å være medikamentpåvirket etter at du ble skrevet ut fra sykehuset?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "tretth",
    type = params$tableFormat,
...
mstt(tab = trettlos, colnames = c("Visste du hva du kunne gjøre med problemet?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "trettvisste",
    type = params$tableFormat,
...
mstt(tab = bil, colnames = c("Fikk du informasjon om sterke smertestillende medikamenter og bilkjøring?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "sterkbil",
    type = params$tableFormat,
...
mstt(tab = hvembil, colnames = c("Av hvem fikk du informasjon om sterke smertestillende medikamenter og bilkjøring?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    label = "hveminfobil",
    type = params$tableFormat,
...
mstt(tab = hvorinfo, colnames = c("Visste du hvor du kunne henvende deg ved spørsmål om bruk av de smertestillende medikamentene?", "Antall ",
                                    "Prosent"),
    cap = paste0(""),
    type = params$tableFormat,
    digs = 0,
