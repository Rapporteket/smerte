...
plotaks <- dat |>
  ...
  dplyr::group_by(SykehusNavn, monthname, AkseptabelSmerte21) |>
  dplyr::summarise(n = dplyr::n()) |>
  dplyr::mutate(ant = sum(n), freq = n/sum(n)) |>
  dplyr::filter(AkseptabelSmerte21 == 1)
...
#Merging the two tibbles
plotaks <- dplyr::bind_rows(plotaks, meanplotaks)
