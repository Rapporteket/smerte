...
```{r behandlertilsynfig, warning = FALSE, message=FALSE, results='asis', fig.width=11.6, fig.height=6}
if (dim(dat)[1] < 1) {
...
Figuren under viser hvordan andelen har fordelt seg i løpet av året.
```{r tilsetthenvistfig, warning = FALSE, message=FALSE, results='asis', fig.width=11.6, fig.height=6}
if (dim(dat)[1] < 1) {
  message <- "I den valgte tidsperioden er det ikke nok data til å vise figur for denne kvalitetsindikatoren."
  } else {
...
Figuren under viser hvordan andelen har fordelt seg i løpet av året.
```{r fornoydfig, warning = FALSE, message=FALSE, results='asis', fig.width=11.6, fig.height=6}
if (dim(dat)[1] < 1) {
  message <- "I den valgte tidsperioden er det ikke nok data til å vise figur for denne kvalitetsindikatoren."
  } else {
