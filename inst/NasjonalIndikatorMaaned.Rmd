...
if (dim(dat)[1] < 1) {
  ...
  #Plotting plotdat
  ggplot2::ggplot(ind1plot, aes(monthname, freq)) + 
...
if (dim(dat)[1] < 1) {
  ...
  ind2plot <- dat %>%
    ...
    dplyr::summarise(n = dplyr::n()) %>% mutate(ant = sum(n), freq = n/sum(n)) %>%
    dplyr::filter(henvtils == 1)
  ...
  #Plotting plotdat
  ggplot2::ggplot(ind2plot, aes(monthname, freq)) + 
    geom_line(aes(group = factor(SykehusNavn), colour=factor(SykehusNavn)), size = 0.8) + geom_point(aes(group = factor(SykehusNavn), colour=factor(SykehusNavn)), size = 2) + 
...
if (dim(dat)[1] < 1) {
  ...
  #Plotting plotdat
  ggplot2::ggplot(ind3plot, aes(monthname, freq)) + 
    geom_line(aes(group = factor(SykehusNavn), colour=factor(SykehusNavn)), size = 0.8) + geom_point(aes(group = factor(SykehusNavn), colour=factor(SykehusNavn)), size = 2) + 
...
if (dim(dat)[1] < 1) {
  ...
  p1 = ggplot2::ggplot(ind41plot, aes(monthname, freq)) + 
    plotdetails +
    labs(
      x = "Måned", y = "Andel",
  ...
  #Plotting plotdat
  p2 = ggplot2::ggplot(ind42plot, aes(monthname, freq)) + 
    plotdetails +
    labs(
      x = "Måned",
      y = "Andel",
  ...
  #Plotting plotdat
  p3 = ggplot2::ggplot(ind43plot, aes(monthname, freq)) + 
    plotdetails +
    labs(
      x = "Måned",
      y = "Andel",
  ...
  #Plotting plotdat
  p4 = ggplot2::ggplot(ind44plot, aes(monthname, freq)) + 
    plotdetails +
    labs(
      x = "Måned",
      y = "Andel",
...
if (dim(plotikmed)[1] < 1) {
  ...
  #Plotting plotdat
  ggplot2::ggplot(plotikmed, aes(monthname, freq)) + 
...
if (dim(plotnedtr)[1] < 1) {
  ...
  #Plotting plotdat
  ggplot2::ggplot(plotnedtr, aes(monthname, freq)) + 
    geom_line(aes(group = factor(SykehusNavn), 
                  colour=factor(SykehusNavn)), size = 0.8) +
    geom_point(aes(group = factor(SykehusNavn), 
                   colour=factor(SykehusNavn)), size = 2) + 
